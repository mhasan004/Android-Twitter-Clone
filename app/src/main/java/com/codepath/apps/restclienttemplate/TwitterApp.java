...
public class TwitterApp extends Application {
    ...
    public void onCreate() {
        ...
        myDatabase = Room.databaseBuilder(this, MyDatabase.class, MyDatabase.NAME)
                .fallbackToDestructiveMigration().build();                     // when upgrading versions, kill the original tables by using fallbackToDestructiveMigration()
        Stetho.initializeWithDefaults(this);                           // use chrome://inspect to inspect your SQL database
    }
